...
import 'package:pixel6_task/ModalClass/EmpModal.dart';
...
class MainScreenState extends State<Mainscreen> {
  ...
  var countryList = [               //created a random list of country
    'India',
    'United States',
    'UK',
    'Sri Lanka',
  ...
  List<Empmodal> filterList = [];     //to display the filtered data i.e. gender or country
  ...
  void initState() {
   ...
   // Empdata(empList, subEmpList);
   // gethttps(10, 0);
   
  }

  Widget header() {                 //function that contain the filter part
    return Padding(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(                         //temperory icon button in appbar
              onPressed: () {},
              icon: const Icon(
                Icons.menu_rounded,
                color: Colors.red,
